...
// Correct the paths for the mocks
jest.mock('../components/Blog/BlogSidebar', () => () => <div data-testid="blog-sidebar">Blog Sidebar</div>);
jest.mock('../components/Blog/CommentsArea', () => () => <div data-testid="comments-area">Comments Area</div>);
...
describe('BlogDetailsContent Component', () => {
  ...
  test('renders the BlogSidebar component', () => {
    render(<BlogDetailsContent />);
    const blogSidebar
     = screen.getByTestId('blog-sidebar');
